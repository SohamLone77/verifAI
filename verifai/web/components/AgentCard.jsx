      ...
      >
        ...
        <div className="flex items-center space-x-4">
          <div className="text-right">
            <p className={`text-lg font-bold ${getScoreColor(agent.score)}`}>
          ...
          >
            <div className="space-y-3">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">{agent.reasoning}</p>
              </div>
              ...
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span>Processing: {agent.processing_time_ms?.toFixed(0)}ms</span>
                <span>Weight: {agent.weight || 1.0}x</span>
              </div>
            </div>
          </motion.div>
        )}
